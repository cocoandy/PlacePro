...
/**
 * 打造一个顶部悬停的Recycle的分割线
 * Created by 曹小贼 on 2018/7/31.
 * <p>
 * 用法 在set到recycler中就好了
 ...
 * itemDecoration.setKeys(presener.mTitles);
 */
...
public class FloatingItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        Log.e("TAG_MAP=", "firstVisiblePos:" + firstVisiblePos);
...
//                Log.e(TAG, "onDrawOver: "+child.getTop()+"$"+firstVisiblePos );
    ...
    public void setBackColor(int res) {
        this.backColor = mContext.getResources().getColor(res);
    }
